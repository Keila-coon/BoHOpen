...
var/station_name		= "SC:V Dagon"
var/const/station_orig	= "SC:V Dagon" //station_name can't be const due to event prefix/suffix
var/const/station_short	= "V.O.R.E."
var/const/dock_name		= "Dagon Central Command"
