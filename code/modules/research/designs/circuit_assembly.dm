...
/datum/design/item/integrated_circuitry/custom_circuit_printer_upgrade_cln
	name = "Integrated circuit printer upgrade - clone upgrade"
	desc = "Allows the integrated circuit printer to dupe assemblies"
