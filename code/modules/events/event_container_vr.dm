...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Space Dust",		/datum/event/dust,	 			5, 		list(ASSIGNMENT_ENGINEER = 20), 0, 0, 50),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Economic News",		/datum/event/economic_event,	300),
		//new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Ian Storm",			/datum/event/ianstorm,	 		1,		list(), 1),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Money Lotto",		/datum/event/money_lotto, 		5, 		list(ASSIGNMENT_ANY = 1), 1, 5, 15),
		//new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Mundane News", 		/datum/event/mundane_news, 		300),
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "PDA Spam",			/datum/event/pda_spam, 			5, 		list(ASSIGNMENT_ANY = 4), 1, 25, 50),
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Atmos Leak",				/datum/event/atmos_leak, 				0,		list(ASSIGNMENT_ENGINEER = 25), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Prison Break",				/datum/event/prison_break,				0,		list(ASSIGNMENT_SECURITY = 100), 1),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Radiation Storm",			/datum/event/radiation_storm, 			50,		list(ASSIGNMENT_MEDICAL = 50), 0),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Random Antagonist",		/datum/event/random_antag,		 		2.5,	list(ASSIGNMENT_SECURITY = 1), 0, 0, 5),
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Spider Infestation",		/datum/event/spider_infestation, 		0,	list(ASSIGNMENT_SECURITY = 40), 1),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Supply Demand",			/datum/event/supply_demand,				10,		list(ASSIGNMENT_ANY = 5, ASSIGNMENT_SCIENCE = 15, ASSIGNMENT_GARDENER = 10, ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_MEDICAL = 15), 1),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Structural Integrity",		/datum/event/window_break, 				15,	list(ASSIGNMENT_ENGINEER = 60), 0),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Hydraulic Failure",		/datum/event/electrified_door, 			25,	list(ASSIGNMENT_ENGINEER = 90, ASSIGNMENT_MEDICAL = 15), 0),
	)
	add_disabled_events(list(
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Atmos Leak",			/datum/event/atmos_leak, 		30,		list(ASSIGNMENT_ENGINEER = 25), 0),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Meteor Strike",		/datum/event/meteor_strike,		0,		list(ASSIGNMENT_ENGINEER = 15)	,0),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Containment Breach",	/datum/event/prison_break/station,0,list(ASSIGNMENT_ANY = 5)),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Space Vines",			/datum/event/spacevine, 		0,	list(ASSIGNMENT_ENGINEER = 15), 0),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Supply Demand",		/datum/event/supply_demand,		5,		list(ASSIGNMENT_ANY = 5, ASSIGNMENT_SCIENCE = 15, ASSIGNMENT_GARDENER = 10, ASSIGNMENT_ENGINEER = 10, ASSIGNMENT_MEDICAL = 15), 1),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Biological Hazard",	/datum/event/viral_outbreak, 	0,	list(ASSIGNMENT_MEDICAL = 25), 1),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Slimes",				/datum/event/escaped_slimes, 	0,	list(ASSIGNMENT_SCIENCE = 45), 0),
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Hydraulic Failure",	/datum/event/electrified_door, 	15,	list(ASSIGNMENT_ENGINEER = 80, ASSIGNMENT_MEDICAL = 5), 0),
	)
	add_disabled_events(list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Wormholes",			/datum/event/wormholes, 		0,	list(ASSIGNMENT_ENGINEER = 5), 0),
	))
